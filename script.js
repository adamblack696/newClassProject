...
const DomElement = function(selector, height, width, bg, fontSize, content, wrap) {
...
const element = new DomElement('.class-name', '100px', '370px', 'red', '16px', content, '.wrap');
element.createTag();